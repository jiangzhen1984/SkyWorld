...
//SAMC_BEGIN
// message from view
#define MESSAGE_FROM_VIEW           @"remote_activity_id"
#define MESSAGE_FROM_VIEW_SEARCH    @1
#define MESSAGE_FROM_VIEW_CHAT      @2
#define MESSAGE_FROM_VIEW_VENDOR    @4
#define MESSAGE_QUESTIONS           @"remote_resp_quest"
//SAMC_END
