...
@property (nullable, nonatomic, retain) NSSet<ReceivedAnswer *> *answers;
...
- (void)addAnswersObject:(ReceivedAnswer *)value;
- (void)removeAnswersObject:(ReceivedAnswer *)value;
- (void)addAnswers:(NSSet<ReceivedAnswer *> *)values;
- (void)removeAnswers:(NSSet<ReceivedAnswer *> *)values;
