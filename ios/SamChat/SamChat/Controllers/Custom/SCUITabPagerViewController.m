...
@interface SCUITabPagerViewController () <SCUITabDelegate, UIPageViewControllerDataSource, UIPageViewControllerDelegate>

@property (strong, nonatomic) UIPageViewController *pageViewController;
@property (strong, nonatomic) SCUITabView *header;
...
@implementation SCUITabPagerViewController
...
- (void)reloadTabs {
    ...
    frame.origin.y = 0;
    frame.size.height = [self headerHeight];
    [self setHeader:[[SCUITabView alloc] initWithFrame:frame tabViews:tabViews tabBarHeight:[self headerHeight] tabColor:[self headerColor] backgroundColor:[self tabBackgroundColor] selectedTabIndex:self.selectedIndex]];
    [[self header] setTabDelegate:self];
