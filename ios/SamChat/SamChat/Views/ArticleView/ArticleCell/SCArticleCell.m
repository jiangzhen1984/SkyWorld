...
#import "SCArticlePhotoContainerView.h"

#import "SCArticleCellOperationMenu.h"
...
@implementation SCArticleCell

{
    UIImageView *_iconView;
    UILabel *_nameLable;
    UILabel *_contentLabel;
    SCArticlePhotoContainerView *_picContainerView;
    UILabel *_timeLabel;
    UIButton *_moreButton;
    UIButton *_operationButton;
    SCArticleCellCommentView *_commentView;
    BOOL _shouldOpenContentLabel;
    SCArticleCellOperationMenu *_operationMenu;
}
...
- (void)setup
{
    ...
    [_moreButton setTitleColor:SC_ARTICLE_CELL_HIGHLIGHT_COLOR forState:UIControlStateNormal];
    ...
    _picContainerView = [SCArticlePhotoContainerView new];
    
    _commentView = [SCArticleCellCommentView new];
    ...
    _operationMenu = [SCArticleCellOperationMenu new];
...
- (void)setModel:(SCArticleCellModel *)model
{
    _model = model;
