...
@interface SamChatHelper()<EMCallManagerDelegate>
{
    NSTimer *_callTimer;
}
...
static SamChatHelper *helper = nil;
...
+ (instancetype)shareHelper
{
    ...
    dispatch_once(&onceToken, ^{
        helper = [[SamChatHelper alloc] init];
    });
    return helper;
}
...
- (void)setExtOfConversation:(EMConversation *)conversation withKey:(NSString *)key
{
