...
#define ENTITY_SESSION_EXTENSTION           @"SessionExtension"
#define SESSION_EXTENSION_SESSION_ID        @"session_id"
#define SESSION_EXTENSION_SEARCH_TAG        @"search_tag"
#define SESSION_EXTENSION_CHAT_TAG          @"chat_tag"
#define SESSION_EXTENSION_SERVICE_TAG       @"service_tag"

#define ENTITY_QUESTION_MESSAGE             @"QuestionMessage"
#define QUESTION_MESSAGE_QUESTION_ID        @"question_id"
#define QUESTION_MESSAGE_SESSSION_ID        @"session_id"
