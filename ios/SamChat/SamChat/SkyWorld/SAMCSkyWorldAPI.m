...
@implementation SAMCSkyWorldAPI
...
+ (NSString *)urlRegisterWithCellphone:(NSString *)cellphone countryCode:(NSNumber *)countrycode username:(NSString *)username password:(NSString *)password
{
    ...
    NSDictionary *data = @{SKYWORLD_HEADER:header,
                           SKYWORLD_BODY:body};
    return [SAMCSkyWorldAPI generateUrlStringWithType:SKYWORLD_APITYPE_USERAPI andData:data];
}
...
+ (NSString *)urlNewQuestionWithQuestion:(NSString *)question
{
    ...
    NSDictionary *data = @{SKYWORLD_HEADER:header,
                           SKYWORLD_BODY:body};
    return [SAMCSkyWorldAPI generateUrlStringWithType:SKYWORLD_APITYPE_QUESTIONAPI andData:data];
}
...
+ (NSString *)urlUpdateUserAvatar
{
    ...
    NSDictionary *data = @{SKYWORLD_HEADER:header,
                           SKYWORLD_BODY:body};
    return [SAMCSkyWorldAPI generateUrlStringWithType:SKYWORLD_APITYPE_USERAVATARAPI andData:data];
}
...
+ (NSString *)urlArticlePublishWithComment:(NSString *)comment
{
    ...
    NSDictionary *data = @{SKYWORLD_HEADER:header,
                           SKYWORLD_BODY:body};
    return [SAMCSkyWorldAPI generateUrlStringWithType:SKYWORLD_APITYPE_ARTICLEAPI andData:data];
}
...
+ (NSString *)urlLogCollection
{
    ...
    NSDictionary *data = @{SKYWORLD_HEADER:header,
                           SKYWORLD_BODY:body};
    return [SAMCSkyWorldAPI generateUrlStringWithType:SKYWORLD_APITYPE_SYSTEMAPI andData:data];
}
