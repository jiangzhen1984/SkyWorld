 ...
 */
public class SearchFragment extends TFragment implements TAdapterDelegate {
	...
	private void registerBroadcastReceiver() {
		...
		intentFilter.addAction(NimConstants.ACTION_SEARCH_UPDATE);
    ...
    private void requestMessages(boolean delay) {
        ...
        getHandler().postDelayed(new Runnable() {
            ...
            public void run() {
			    ...
			    /*SAMC_BEGIN()*/
                        List<RecentContact> search_recents = new ArrayList<RecentContact>();
			    for(RecentContact result:recents){
                            if((result.getTag() & NimConstants.RECENT_TAG_SHOW_IN_SEARCH)!=0){
                                search_recents.add(result);
				 }
			    }

			    loadedRecents = search_recents;
			    /*SAMC_END()*/
