...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    // �������
    protected String sessionId; // p2p�Է�Account����Ⱥid
    ...
    public void onResume() {
        ...
        getActivity().setVolumeControlStream(AudioManager.STREAM_VOICE_CALL); // Ĭ��ʹ����Ͳ����
    }
    ...
    private void parseIntent() {
        ...
        /*SAMC_BEGIN()*/
        from_which_window = getArguments().getInt(Extras.EXTRA_FROM_WHICH_WINDONW);
        /*SAMC_END()*/
    ...
    public boolean sendMessage(IMMessage message) {
        ...
        /*SAMC_BEGIN()*/
        if(from_which_window !=0){
           Map<String, Object> ext = new HashMap<>();
           ext.put(NimConstants.MSG_REMOTE_KEY,from_which_window);

           if((from_which_window & NimConstants.MSG_FROM_PROS) !=0){
	           List<String> quest_list = NimUIKit.samListner.getNotResponsedQuestion(message.getSessionId());
               if(quest_list!=null){
			     ...
			     if(questions!=null){
				    ext.put(NimConstants.MSG_REMOTE_RESP_QUEST_KEY,questions);
			     }
               }
           }
