...
public class DatabaseHelper extends SQLiteOpenHelper
{
	...
	*/
	public static final String TABLE_NAME_RESP_QUEST = "RespQuestTable";
	...
	*/
	...
	/*
		id(primary) |question_id | question | status | send time | cancel time | 
	*/
		StringBuffer sBuffer = new StringBuffer();
	...
	private void createQuestRespTable(SQLiteDatabase db){
	/*
		id(primary)|receiver_name|sender_name|question_id
	*/
		StringBuffer sBuffer = new StringBuffer();
		sBuffer.append("CREATE TABLE [" + TABLE_NAME_RESP_QUEST + "] (");
		sBuffer.append("[id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, ");
        	sBuffer.append("[receiver_name] TEXT, ");
       	sBuffer.append("[sender_name] TEXT,");
		sBuffer.append("[question_id] TEXT)");
		// 执行创建表的SQL语句
        	db.execSQL(sBuffer.toString());
	}
	...
	*/
	...
	db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_RESP_QUEST);
