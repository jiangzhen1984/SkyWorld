...
public class MapHelper {
	...
	private static Intent intentForAmap(NimLocation origin, NimLocation des) {
		...
		String str = String.format("androidamap://route?sourceApplication=yixin&slat=%f&slon=%f&sname=Æðµã&dlat=%f&dlon=%f&dname=ÖÕµã&dev=0&m=0&t=0&showType=1", arrayOfObject);
		Intent intent;
		try {
