...
public class ReminderManager {
    ...
    /*SAMC_BEGIN()*/
    public final void updateSearchUnreadNum(int unreadNum) {
        updateUnreadMessageNum(unreadNum, false, ReminderId.SEARCH);
    }

    public final void updateSearchDeltaUnreadNum(int delta) {
        updateUnreadMessageNum(delta, true, ReminderId.SEARCH);
    }

    public final void updateProsUnreadNum(int unreadNum) {
        updateUnreadMessageNum(unreadNum, false, ReminderId.PROS);
    }

    public final void updateProsDeltaUnreadNum(int delta) {
        updateUnreadMessageNum(delta, true, ReminderId.PROS);
    }
    /*SAMC_END()*/
    ...
    private final void populate(SparseArray<ReminderItem> items) {
        ...
        /*SAMC_BEGIN()*/
        items.put(ReminderId.SEARCH,new ReminderItem(ReminderId.SESSION));
        items.put(ReminderId.PROS,new ReminderItem(ReminderId.PROS));
        /*SAMC_END()*/
    }
