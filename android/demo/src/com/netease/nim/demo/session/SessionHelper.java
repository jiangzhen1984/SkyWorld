...
public class SessionHelper {
    ...
    /*SAMC_BEGIN()*/
    public static void startP2PSession(Context context, String account,int from_which_window) {
        if (!DemoCache.getAccount().equals(account)) {
            NimUIKit.startChatting(context, account, SessionTypeEnum.P2P, from_which_window,getP2pCustomization());
        } else {
            NimUIKit.startChatting(context, account, SessionTypeEnum.P2P, from_which_window,getMyP2pCustomization());
        }
    }
    /*SAMC_END()*/
